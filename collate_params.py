...
if __name__ == "__main__":
    model = ssdlite_with_quant_weights("./weights/params.pth")
    state_dict = model.state_dict()
    for key in state_dict.keys():
        print(key)
    print(state_dict['backbone.features.0.1.block.1.0.scale'])
    print(state_dict['backbone.features.0.1.block.1.0.zero_point'])
    print(state_dict['backbone.features.0.1.skip_add.scale'])
    print(state_dict['backbone.features.0.1.skip_add.zero_point'])
    # iact_scales, iact_zero_points, wgt_scales, bias_scales = get_quant_factors(state_dict)
    # print(iact_scales)
    # print(iact_zero_points)
    # print(wgt_scales)
    # print(bias_scales)